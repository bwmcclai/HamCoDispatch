/* ===================================
   HAMILTON COUNTY DISPATCH — Vercel Serverless API
   HamCoDispatch.com
...
module.exports = async (req, res) => {
    ...
    if (pathname === '/api/stations') {
        return res.json({ success: true, stations: FIRE_STATIONS });
    }

    // ── /api/codes ──
    if (pathname === '/api/codes') {
        return res.json({ success: true, codes: TEN_CODES });
    }
